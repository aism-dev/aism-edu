...
export const admissionSteps: AdmissionStep[] = [
  {
    ...
    content: (
      <div className="grid gap-3">
        <p className="text-balance sm:max-w-[clamp(40rem,70%,25rem)] max-w-full">
        ...
        <p className="text-balance sm:max-w-[clamp(40rem,70%,25rem)] max-w-full">Ensure all documents are ready to avoid delays in processing.</p>
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <div className="grid gap-3">
        ...
        <p className="text-balance sm:max-w-[clamp(40rem,70%,25rem)] max-w-full"><strong>What&apos;s required:</strong></p>
        <ul className="grid gap-2 my-3">
          <li className="">
  ...
  },
  {
    ...
    content: (
      <div className="grid gap-3">
        ...
        <p className="text-balance sm:max-w-[clamp(40rem,70%,25rem)] max-w-full"><strong>Housing options:</strong></p>
        <ul className="grid gap-2 my-3">
